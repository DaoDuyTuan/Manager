...
public class combobox extends javax.swing.JFrame {
    ...
    public combobox() {
        ...
        Jcombo.setModel(combox);
        gen = new genDAO();
        List<Gender> list = gen.showGender();
        for (Gender gender : list) {
            combox.addElement(gender);
        }
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(87, 87, 87)
                .addComponent(Jcombo, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(click)
